<template>
    ...
    <!-- <h6> Generated on : {{showGeneratedTime}}</h6> &nbsp;&nbsp;&nbsp; -->
     ...
     <table class="table table-bordered">
      <thead>
        <tr>
          <th class="border font-weight-bold border-dark bg-light text-center" v-for="(header,key) in headers" :key="key">
            <h3>{{ header.key }}</h3>
          </th>
        </tr>
      </thead>
      <tbody>
       <tr v-for="(item,index) in items" v-bind:key="item.id">
              ...
              <td style="font-size: large;" class="border border-dark">{{item.mobileNo}}<br/>{{item.email}}</td>
              <td style="font-size: large;" class="border border-dark">
                <span v-if="item.travelDetail.length > 0 && item.travelDetail[0].arrivalTo != null && item.travelDetail[0].arrivalTo != '' && item.travelDetail[0].arrivalTo != undefined">
                    {{item.travelDetail[0].arrivalTo.split('##')[1]}}
                </span>
                <span v-else>-</span>,
                <span v-if="item.travelDetail.length > 0 && item.travelDetail[0].arrivalTravelMode.name != null && item.travelDetail[0].arrivalTravelMode.name != '' && item.travelDetail[0].arrivalTravelMode.name != undefined">
                    {{item.travelDetail[0].arrivalTravelMode.name}}
                </span>
                <span v-else>-</span> -
                <span v-if="item.travelDetail.length > 0 && item.travelDetail[0].arrivalVehicleNumber != null && item.travelDetail[0].arrivalVehicleNumber != '' && item.travelDetail[0].arrivalVehicleNumber != undefined">
                    {{item.travelDetail[0].arrivalVehicleNumber}}</span>
                <span v-else>-</span><br/>
                <span v-if="item.travelDetail.length > 0 && item.travelDetail[0].arrivalStartDate != null && item.travelDetail[0].arrivalStartDate != '' && item.travelDetail[0].arrivalStartDate != undefined">
                    {{item.travelDetail[0].arrivalStartDate}}
                </span>
                <span v-else>-</span><br/>
                ---------------- <br/>
                <span v-if="item.travelDetail.length > 0 && item.travelDetail[0].departureTravelMode != null && item.travelDetail[0].departureTravelMode != '' && item.travelDetail[0].departureTravelMode != undefined">
                    {{item.travelDetail[0].departureTravelMode.name}}
                </span>
                <span v-else>-</span> - 
                <span v-if="item.travelDetail.length > 0 && item.travelDetail[0].departureVehicleNumber != null && item.travelDetail[0].departureVehicleNumber != '' && item.travelDetail[0].departureVehicleNumber != undefined">
                    {{item.travelDetail[0].departureVehicleNumber}}
                </span>
                <span v-else>-</span><br/>
                <span v-if="item.travelDetail.length > 0 && item.travelDetail[0].departureDate != null && item.travelDetail[0].departureDate != '' && item.travelDetail[0].departureDate != undefined">
                    {{item.travelDetail[0].departureDate}}</span>
                <span v-else>-</span>
             </td>
              ...
              <td style="font-size: large;" class="border border-dark">
                <span v-if="item.family.length > 0 && item.family[0].name != null && item.family[0].name != '' && item.family[0].name != undefined && item.family[0].title.name != null && item.family[0].title.name != '' && item.family[0].title.name != undefined">
                    {{item.family[0].title.name}} {{item.family[0].name}}</span>
                    <span v-else>-</span>
                </td>
              <td style="font-size: large;" class="border border-dark">
                <span v-if="item.family.length > 0 && item.family[0].mobileNo != null && item.family[0].mobileNo != '' && item.family[0].mobileNo != undefined">
                    {{item.family[0].mobileNo}}</span>
                    <span v-else>-</span><br/>
                    <span v-if="item.family.length > 0 && item.family[0].email != null && item.family[0].email != '' && item.family[0].email != undefined">
                    {{item.family[0].email}}</span>
                    <span v-else>-</span>
                </td>
              <td style="font-size: large;" class="border border-dark">
                <span v-if="item.travelDetail.length > 1 && item.travelDetail[1].arrivalTo != null && item.travelDetail[1].arrivalTo != '' && item.travelDetail[1].arrivalTo != undefined">
                    {{item.travelDetail[1].arrivalTo.split('##')[1]}}</span>
                    <span v-else>-</span>,
                <span v-if="item.travelDetail.length > 1 && item.travelDetail[1].arrivalTravelMode.name != null && item.travelDetail[1].arrivalTravelMode.name != '' && item.travelDetail[1].arrivalTravelMode.name != undefined">
                {{item.travelDetail[1].arrivalTravelMode.name}}</span>
                <span v-else>-</span> -
                <span v-if="item.travelDetail.length > 1 && item.travelDetail[1].arrivalVehicleNumber != null && item.travelDetail[1].arrivalVehicleNumber != '' && item.travelDetail[1].arrivalVehicleNumber != undefined">
                    {{item.travelDetail[1].arrivalVehicleNumber}}</span>
                    <span v-else>-</span> <br/>
                <span v-if="item.travelDetail.length > 1 && item.travelDetail[1].arrivalStartDate != null && item.travelDetail[1].arrivalStartDate != '' && item.travelDetail[1].arrivalStartDate != undefined">
                    {{item.travelDetail[1].arrivalStartDate}}</span>
                <span v-else>-</span><br/>
                ---------------- <br/>
                <span v-if="item.travelDetail.length > 1 && item.travelDetail[1].departureTravelMode != null && item.travelDetail[1].departureTravelMode != '' && item.travelDetail[1].departureTravelMode != undefined">
                    {{item.travelDetail[1].departureTravelMode.name}}</span>
                    <span v-else>-</span> -
                    <span v-if="item.travelDetail.length > 1 && item.travelDetail[1].departureVehicleNumber != null && item.travelDetail[1].departureVehicleNumber != '' && item.travelDetail[1].departureVehicleNumber != undefined">
                    {{item.travelDetail[1].departureVehicleNumber}}</span><span v-else>-</span> <br/>
                    <span v-if="item.travelDetail.length > 1 && item.travelDetail[1].departureDate != null && item.travelDetail[1].departureDate != '' && item.travelDetail[1].departureDate != undefined">
                    {{item.travelDetail[0].departureDate}}</span><span v-else>-</span>
              </td>
              <td style="font-size: large;" class="border border-dark">
             ...
             <td style="font-size: large;" width="10%" class="border border-dark">
  ...
  export default {
    data() {
      return {
        ...
        selectMode: "single",
        selected: null,
         headers: [{key:"Sr.No"},{key:"State"},{key:"Designation"},{key:"Delegate's Pics"},{key:"Delegate's Name"},{key:"Delegate's Contact Details"},{key: "Delegate's Travel Details"},{key:"Spouse Photo"},{key:"Spouse Name"},{key:"Spouse Contact Details"},{key:"Spouse Travel Details"},{key:"Liasion Officer"},{key:"Accomodation"},{key:"Driver"}],
