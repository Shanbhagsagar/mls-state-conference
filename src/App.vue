<template>
  <div id="app">
    ...
    <div
      class="wrapper"
      :class="{ 'wrapper-lg' : $route.path == '/StudentDetails' || $route.path=='/view-student-details-admin' || $route.path == '/' || $route.path == '/about' || $route.path == '/login' || $route.path == '/StudentDetails' || $route.path=='/logout' ||$route.path=='/registration'|| $route.path=='/termsandconditions'|| $route.path == '/studentregistration' || $route.path == '/recipentRegistration' || $route.path == '/success' || $route.path == '/reset-password' }"
    >
