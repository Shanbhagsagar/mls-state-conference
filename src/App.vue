<template>
  <div id="app">
    ...
    <div
      class="wrapper"
      :class="{ 'wrapper-lg' : $route.path == '/StudentDetails' || $route.path == '/HireUs' ||  $route.path=='/view-student-details-admin' || $route.path == '/' || $route.path == '/about' || $route.path == '/login' || $route.path == '/StudentDetails' || $route.path=='/logout' ||$route.path=='/registration'|| $route.path=='/termsandconditions'|| $route.path == '/studentregistration' || $route.path == '/recipentRegistration' || $route.path == '/success' || $route.path == '/reset-password' || $route.path== '/profile' || $route.path== '/updateregistration'}">
      ...
      <sidebar v-if="$route.path!='/' && $route.path !== '/HireUs' && $route.path!=='/termsandconditions' && $route.path !== '/StudentDetails' && $route.path!='/studentregistration' && $route.path!='/updateDonor' && $route.path!='/updateRecipient' && $route.path!='/registration' && $route.path!='/recipentRegistration' && $route.path!='/login' && $route.path!='/logout' && $route.path!='/about' && $route.path!='/success' && $route.path!= '/reset-password' && $route.path!= '/profile' && $route.path!= '/updateregistration'"  />
