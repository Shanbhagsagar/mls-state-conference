      ...
      <div class="card-sinfo">
        <div class="row no-gutters">
          <div class="col-md-4 card-items">
            <div class="label">विद्यार्थ्याचे नाव/Student Name:</div>
            <div class="value">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-4 card-items" v-if="showGuardianFlag">
            <div class="label">Parent or Guardian Name</div>
            <div class="value">
              {{ userDetails[0].parentOrGuardianName }}
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <!-- <div class="col-md-6">
            <div class="form-group">
              ...
              <v-select
                v-model="userDetails[0].mockExamCategory"
                label="categoryName"
          ...
          >
            <!-- <div class="form-group">
              <label for="exam" class="control-label form-label">
                परीक्षा निवडा/Select Exam</label
              >
              <v-select
                v-model="userDetails[0].educationLevel"
                label="displayName"
                :options="educationLevel"
                :value="userDetails[0].educationLevel"
                @input="
          ...
          >
            <!-- <div class="form-group">
              <label for="universityName" class="control-label form-label">
                विद्यापीठाचे नाव/University Name</label
              >
              <v-select
                v-model="userDetails[0].selectedUniversity"
                label="universityName"
                :options="universities"
                :value="userDetails[0].selectedUniversity"
                @input="
